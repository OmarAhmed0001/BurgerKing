...
add_category_get = function(req, res, next) {
    res.render('add_category', { pageTitle: 'Add Category', editingc: false });
};
...
update_category_get = function(req, res, next) {
    ...
    Category.findOne({ _id: id }, (error, result) => {
        console.log(result);
        res.render('add_category', { pageTitle: 'Edit Category', editingc: editMode, category: result });
    });

};
update_product_get = function(req, res, next) {
    const editMode = req.query.editp;
    ...
    Product.findOne({ _id: id }, (error, result) => {
        res.render('add_product', {pageTitle: 'Edit Product', editingp: editMode, pro: result, Category: cat });
    })
};
add_product_get = function(req, res, next) {
    Category.find({}, (error, resultc) => {
        res.render('add_product', { pageTitle: 'Add Product', editingp: false ,Category: resultc });
    });
};
